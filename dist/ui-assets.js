...
var A = ["disabled"], j = {
	...
	key: 2,
	class: "absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2.5 py-1.5 text-xs font-medium text-white bg-surface-900 rounded-lg z-[1] w-fit max-w-96 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-150 shadow-lg"
}, W = ["onClick"], G = {
	key: 0,
	class: "w-10 px-4 py-3"
